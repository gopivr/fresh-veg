...
@EnableConfigurationProperties(SupplySecurityProperties.class)
public class SupplyJwtConfiguration {
    @Bean
    JwtDecoder supplyJwtDecoder(SupplySecurityProperties properties) {
