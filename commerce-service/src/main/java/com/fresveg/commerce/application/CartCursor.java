...
@Component
public class CartCursor {
    private final JsonMapper mapper;
    public CartCursor(JsonMapper mapper) { this.mapper=mapper; }
    public String fingerprint(Object filters) {
        ...
        } catch (Exception error) { throw new IllegalStateException("Cannot encode commerce filters", error); }
    }
    ...
    public Position decode(String cursor, String expectedFilter) {
        ...
        try {
            ...
            throw new CommerceException(HttpStatus.BAD_REQUEST,"CRT-400-002","Invalid cursor or cursor filters have changed.");
        }
    }
