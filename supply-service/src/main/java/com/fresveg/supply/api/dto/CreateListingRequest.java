...
public record CreateListingRequest(@NotNull UUID locationId, @NotNull UUID productId, @NotNull UUID variantId,
        ...
        @NotNull @Size(max=50) List<@NotNull @Valid PriceRequest> prices) implements ListingInput { }
