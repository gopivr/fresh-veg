...
public class CatalogCursor {
    ...
    public CatalogCursor(JsonMapper mapper) { this.mapper=mapper; }
    public String fingerprint(Object filters) {
        ...
        } catch (Exception error) { throw new IllegalStateException("Cannot encode catalog filters", error); }
    }
    ...
    public Position decode(String cursor, String expectedFilter) {
        ...
        try {
            ...
            throw new CatalogException(HttpStatus.BAD_REQUEST,"CAT-400-002","Invalid cursor or cursor filters have changed.");
        }
    }
