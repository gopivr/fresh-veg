...
public class CatalogJson {
    ...
    public CatalogJson(JsonMapper mapper) { this.mapper=mapper; }
    ...
    private static CatalogException invalid() {
        return new CatalogException(HttpStatus.BAD_REQUEST,"CAT-400-003","Attributes must be a JSON object of at most 16 KiB, 64 top-level keys and depth 8.");
    }
}
