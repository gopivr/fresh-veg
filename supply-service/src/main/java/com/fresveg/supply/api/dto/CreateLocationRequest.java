...
public record CreateLocationRequest(@NotBlank @Pattern(regexp="[A-Z0-9][A-Z0-9_-]{0,63}") String code,
        ...
        @NotBlank @Pattern(regexp="[A-Z]{2}") String countryCode,@NotNull LocationStatus status) implements LocationInput { }
