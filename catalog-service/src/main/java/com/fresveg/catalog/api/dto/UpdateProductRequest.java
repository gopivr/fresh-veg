...
public record UpdateProductRequest(@NotBlank @Pattern(regexp="[A-Z0-9][A-Z0-9_-]{0,63}") String code,
        ...
        @NotNull @Size(max=20) List<@NotNull @Valid ImageRequest> images, @NotNull @PositiveOrZero Long version) implements ProductInput { }
